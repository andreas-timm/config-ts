...
```markdown
# [0.2.0](https://github.com/andreas-timm/config-ts/compare/0.1.0...0.2.0) (2026-07-02)
...
- `RELEASE_GIT_NAME` and `RELEASE_GIT_EMAIL` actions variables: the Git identity of the release commits and
  ...
  ```sh
  gh variable set RELEASE_GIT_NAME --repo andreas-timm/config-ts --body '<NAME>'
  gh variable set RELEASE_GIT_EMAIL --repo andreas-timm/config-ts --body '<EMAIL>'
  ```
